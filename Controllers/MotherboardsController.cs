...
namespace ComputerParts.Controllers
{
    public class MotherboardsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MotherboardId,Image,Name,Information,Price")] Motherboard motherboard)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MotherboardId,Image,Name,Information,Price")] Motherboard motherboard)
        {
            if (ModelState.IsValid)
            {
