...
namespace ComputerParts.Controllers
{
    public class MonitorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MonitorId,Image,Name,Information,Price")] Monitor monitor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MonitorId,Image,Name,Information,Price")] Monitor monitor)
        {
            if (ModelState.IsValid)
            {
