...
namespace ComputerParts.Controllers
{
    public class RAMsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RAMId,Image,Name,Information,Price")] RAM rAM)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RAMId,Image,Name,Information,Price")] RAM rAM)
        {
            if (ModelState.IsValid)
            {
